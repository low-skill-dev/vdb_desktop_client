...
public class StringCryptographyNoStackAllocHeap
{
	...
	public void CanEncryptAndDecrypt1()
	{
		...
		var encrypted = CryptoHelper.StringCryptocraphyNoStackAlloc.EncryptString(key, testToken);

		var dectypted = CryptoHelper.StringCryptocraphyNoStackAlloc.DecryptString(key, encrypted);
